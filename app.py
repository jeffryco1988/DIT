...
# 🔥 DIRECT GOOGLE DRIVE LINKS (must be public)
...
disease_info = {
    "Healthy": "Malusog ang halaman.",
    "Mosaic": "Tanggalin ang infected na dahon.",
    "RedRot": "Putulin at sunugin ang apektadong bahagi.",
    "Rust": "Mag-spray ng fungicide kung kinakailangan.",
    "Yellow": "Magdagdag ng nitrogen fertilizer."
}

...
# =====================================
# LOAD SAVED GROWTH MODEL
# =====================================

pipeline = joblib.load("growth_model.pkl")
...
disease_info = {
    ...
    "RedRot": "Putulin at sunugin ang apektadong bahagi. Gumamit ng resistant varieties.",
    "Rust": "Mag-spray ng fungicide kung kinakailangan at panatilihin ang airflow.",
